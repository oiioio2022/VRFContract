...
contract VRFConsumer is VRFConsumerBase {
  ...
  // Call the requestRandomWords method of the Consumer contract to asynchronously request VRF random numbers
  ...
  // Call the syncRequestRandomWords method of the Consumer contract to obtain a list of random numbers synchronously
